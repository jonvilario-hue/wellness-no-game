...
import { useDashboardSettings, type DashboardSettings, componentLabels } from '@/hooks/use-dashboard-settings';

const dashboardLayoutKeys: (keyof typeof componentLabels)[] = [
    'mainDashboard',
    'dailyChallenge',
    'allGames',

...
const ElementDisplay = ({ element }: { element: NeutralElement | null }) => {
  if (!element) return null;
  return <ShapeComponent {...element} />;
};

export default function MatrixReasoning() {
  ...
  const handleNextPuzzle = useCallback(() => {
    ...
    logGameResult('Gf', 'neutral', { score: puzzleScore, time });
  ...
  const handleSelectOption = useCallback((option: NeutralElement) => {

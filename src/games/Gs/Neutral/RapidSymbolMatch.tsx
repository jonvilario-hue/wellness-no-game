...
export default function RapidSymbolMatch() {
  ...
  useEffect(() => {
    ...
    if (gameState === 'running' && timeLeft > 0) {
      ...
      logGameResult('Gs', 'neutral', { score, time });
    }
    return () => clearTimeout(timer);
  }, [gameState, timeLeft, score, startTime, logGameResult]);
  ...
  return (
    <Card className="w-full max-w-2xl text-center">
      <CardHeader>
        <CardTitle>(Gs) Rapid Symbol Match</CardTitle>

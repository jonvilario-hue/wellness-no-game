...
import { CheckCircle2, ChevronRight, ListChecks, ArrowLeft, Lightbulb } from 'lucide-react';
                ...
                <div className="flex items-center gap-4 p-6">
                  ...
                  <div className="flex-grow min-w-0">
                    ...
                    <div className="flex items-center gap-2 mt-1 text-[10px] font-bold uppercase tracking-widest text-muted-foreground">
                      <ListChecks className="w-3 h-3" /> {day.actions.length} DRILLS • {day.estimatedMinutes} MIN
                    </div>
                  </div>
                </div>

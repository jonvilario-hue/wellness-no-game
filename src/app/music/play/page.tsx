...
import { ArrowLeft, Guitar, ListChecks } from 'lucide-react';
  ...
  return (
    <div className="container max-w-2xl mx-auto p-12 text-center space-y-8 animate-in fade-in">
      <div className="space-y-4">
        ...
        <h1 className="text-4xl font-black uppercase tracking-tighter">Instrument Domain</h1>

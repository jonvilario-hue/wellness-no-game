    ...
    return (
      <div className="container max-w-xl mx-auto py-12 px-4 space-y-8 animate-in fade-in">
        <div className="text-center space-y-2">
          <h1 className="text-3xl font-black uppercase">Melodic Freeflow</h1>
          <p className="text-muted-foreground">No correct answers. Just ride the harmony.</p>
        </div>
        ...
        <Card className="p-6 space-y-6">
          ...
          <Button size="lg" className="w-full h-14 font-bold text-lg" onClick={handleStart}>Launch Flow</Button>
        </Card>
      </div>
    );
  }
  ...
  return (
    ...
    >
      <div className="w-full flex flex-col items-center gap-12">
        ...
        {gameState === 'summary' && (
          <Button onClick={finish} size="lg" className="mt-4 font-bold">End Session</Button>
        )}
      </div>
    </GameShell>
  );

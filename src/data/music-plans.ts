...
export const musicPlans: MusicJourneyPlan[] = [
  {
    ...
    description: "Progress from basic interval recognition to complex chord progression identification.",
    durationDays: 7,
    steps: [
      ...
      { day: 4, title: "Basic Progressions", domain: "Theory & Harmony", drill: "Progression Analysis", difficulty: "Beginner", estimatedMinutes: 10 },
      { day: 5, title: "Melodic Dictation I", domain: "Ear Training", drill: "Melody Dictation", difficulty: "Intermediate", estimatedMinutes: 10 },
      { day: 6, title: "The 7th Chord", domain: "Ear Training", drill: "Seventh Chord ID", difficulty: "Intermediate", estimatedMinutes: 12 },
  ...
  },
  {
    ...
    durationDays: 21,
    steps: [
      { day: 1, title: "Awareness Audit", domain: "Critical Listening", drill: "Instrument Identification", difficulty: "Beginner", estimatedMinutes: 10 }
    ]
  }
];

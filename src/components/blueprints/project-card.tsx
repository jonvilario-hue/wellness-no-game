...
import type { Project } from '@/hooks/use-blueprint-store';
...
export function ProjectCard({ project }: ProjectCardProps) {
  const { updateProject, deleteProject, addMilestone } = useBlueprintStore();
             ...
             <AlertDialog>
                ...
                <AlertDialogContent>
                    <AlertDialogHeader>
                        ...
                        <AlertDialogDescription>
                            Are you sure you want to delete this blueprint and all its milestones and tasks? This action cannot be undone.
                        </AlertDialogDescription>
                    </AlertDialogHeader>
                    <AlertDialogFooter>

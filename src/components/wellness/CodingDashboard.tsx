...
export function CodingDashboard() {
  ...
  const recommendation = useMemo(() => {
    // Determine loop based on track
    const loop = [];
    let label = "";
    let time = 0;

    if (activeTrack === 'Foundation') {
      label = "Verification Mastery Loop";
      time = 15;
      loop.push(
      ...
      label = "Systems Architecture Loop";
      time = 22;
      loop.push(
        { lane: 'Write', type: 'Syntax Sprints' },
  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center px-1">
        ...
        <AssistantTooltip text="The drills in this lab are synthetically curated 'gym reps' based on official language specifications and common algorithmic patterns.">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
        ...
        <AssistantTooltip text="Total minutes spent in coding drills this week.">
          <Card className="bg-primary/5 border-primary/10 h-full">
            <CardContent className="p-4 flex flex-col items-center justify-center text-center">
        ...
        <AssistantTooltip text="The lane where you've invested the most reps.">
          <Card className="bg-primary/5 border-primary/10 h-full">
            <CardContent className="p-4 flex flex-col items-center justify-center text-center">
      ...
      {lowEnergyMode && (
        <Card className="border-primary/20 bg-primary/5 shadow-md overflow-hidden group hover:border-primary/40 transition-all animate-in fade-in slide-in-from-top-2">

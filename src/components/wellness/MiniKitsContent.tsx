  ...
  return (
    <div className="max-w-4xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {kits.map((kit, index) => (
                <Card key={index} id={`kit-${kit.title.toLowerCase().replace(/ /g, '-')}`} className="hover:shadow-md scroll-mt-20 flex flex-col">
                <CardContent className="p-6 space-y-4 flex-grow">
                    ...
                    <div className="space-y-3 text-sm p-4 bg-muted/50 rounded-lg flex-grow">
                        <div>

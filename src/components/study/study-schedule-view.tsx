...
import { CalendarDays, Play, Clock, AlertCircle, CheckCircle2, PlusCircle } from 'lucide-react';
  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center px-2">
        ...
        <AssistantTooltip text="Manually add a study event to your calendar. This allows you to block out time for topics not yet in your vault.">
          <AddToCalendarDialog 
            toolId="Custom" 
            resourceId="manual-entry" 
            resourceName="Ad-hoc Study"
            buttonVariant="outline"
            buttonSize="sm"
            className="font-bold border-primary/20"
          >
            <span className="flex items-center gap-2">
              <PlusCircle className="w-4 h-4" /> Schedule Training
            </span>
          </AddToCalendarDialog>
        </AssistantTooltip>
      </div>
      ...
      {scheduledSessions.length === 0 ? (
        <div className="text-center py-20 border-2 border-dashed rounded-xl bg-muted/20">
          ...
          <p className="text-sm text-muted-foreground mt-2 max-w-sm mx-auto">
            Schedule specific topics or decks to your calendar from the tools below, or use the "Schedule Training" button above.
          </p>
        </div>
      ) : (
        <AssistantTooltip text="All study events you've manually added to your calendar appear here. Use this to batch your deep work sessions.">

...
export const chcDomains: { 
  ...
  { key: 'Gf', name: '(Gf) Fluid Reasoning', description: 'Solve new problems', gameTitle: 'Pattern Matrix', tasks: ['pattern_matrix'] },
  { key: 'Gc', name: '(Gc) Crystallized Intelligence', description: 'Use learned knowledge', gameTitle: 'Verbal Inference Builder', tasks: ['verbal_inference'] },
  { key: 'Gwm', name: '(Gwm) Working Memory', description: 'Hold and use info', gameTitle: 'Dynamic Sequence Transformer', tasks: ['sequence_transform'] },
  { key: 'Gs', name: '(Gs) Processing Speed', description: 'Work fast and accurately', gameTitle: 'Rapid Code Match', tasks: ['code_match'] },

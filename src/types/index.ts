...
export const chcDomains: { 
  ...
  { key: 'Gwm', name: '(Gwm) Working Memory', description: 'Use and hold information', gameTitle: 'Sequence Dynamics', tasks: ['sequence_transform'], supportsMath: true },
  ...
  { key: 'Gv', name: '(Gv) Visual Processing', description: 'Visualize and rotate objects', gameTitle: 'Mental Rotation Lab', tasks: ['mental_rotation'], supportsMath: true },
  { key: 'Ga', name: '(Ga) Auditory Processing', description: 'Process and distinguish sounds', gameTitle: 'Tone Grid Challenge', tasks: ['tone_grid'], supportsMath: true },
